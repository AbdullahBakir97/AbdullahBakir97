...
_Generated 2026-09-06. 11 findings across 87 repos (9 flagged)._
...
- **[high]** `bug-debt` — Bug debt: AbdullahBakir97/PortfolioCraft
  - 1 open issues; the oldest is 129 days old. Long-lived issues compound and signal abandonment to visitors.
  - Label weight: × 3 (dominant labels: priority: high)
  - Evidence: [1 open · oldest 129 days](https://github.com/AbdullahBakir97/PortfolioCraft/issues)
...
- **[high]** `pr-rot` — Stale PR: AbdullahBakir97/JS-TO-DO-LIST#1
  - This PR has been open for 1183 days. Review or close at https://github.com/AbdullahBakir97/JS-TO-DO-LIST/pull/1 to keep your contribution graph honest.
  - Awaiting: unknown (1183 days)
  - Evidence: [Opened 1183 days ago](https://github.com/AbdullahBakir97/JS-TO-DO-LIST/pull/1)
  - **Action:** Update with a fresh comment, mark as draft, or close.

- **[high]** `pr-rot` — Stale PR: bloghd/bloghd#1
  - This PR has been open for 133 days. Review or close at https://github.com/bloghd/bloghd/pull/1 to keep your contribution graph honest.
  - Awaiting: unknown (133 days)
  - Evidence: [Opened 133 days ago](https://github.com/bloghd/bloghd/pull/1)
  - **Action:** Update with a fresh comment, mark as draft, or close.

- **[medium]** `bug-debt` — Bug debt: AbdullahBakir97/Project-Management-Tool
  - 2 open issues; the oldest is 829 days old. Long-lived issues compound and signal abandonment to visitors.
  - Label weight: × 2 (dominant labels: bug)
  - Evidence: [2 open · oldest 829 days](https://github.com/AbdullahBakir97/Project-Management-Tool/issues)
  - **Action:** Triage stale issues — close, label, or convert to discussions.
