...
_Generated 2026-05-31. 11 findings across 87 repos (9 flagged)._
...
- **[high]** `pr-rot` — Stale PR: AbdullahBakir97/JS-TO-DO-LIST#1
  - This PR has been open for 1085 days. Review or close at https://github.com/AbdullahBakir97/JS-TO-DO-LIST/pull/1 to keep your contribution graph honest.
  - Awaiting: unknown (1085 days)
  - Evidence: [Opened 1085 days ago](https://github.com/AbdullahBakir97/JS-TO-DO-LIST/pull/1)
...
- **[medium]** `bug-debt` — Bug debt: AbdullahBakir97/Project-Management-Tool
  - 2 open issues; the oldest is 731 days old. Long-lived issues compound and signal abandonment to visitors.
  - Label weight: × 2 (dominant labels: bug)
  - Evidence: [2 open · oldest 731 days](https://github.com/AbdullahBakir97/Project-Management-Tool/issues)
  - **Action:** Triage stale issues — close, label, or convert to discussions.

- **[medium]** `pr-rot` — Stale PR: bloghd/bloghd#1
  - This PR has been open for 35 days. Review or close at https://github.com/bloghd/bloghd/pull/1 to keep your contribution graph honest.
  - Awaiting: unknown (35 days)
  - Evidence: [Opened 35 days ago](https://github.com/bloghd/bloghd/pull/1)
  - **Action:** Update with a fresh comment, mark as draft, or close.
