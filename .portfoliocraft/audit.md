...
_Generated 2026-08-07. 9 findings across 86 repos (8 flagged)._
...
- **[high]** `pr-rot` — Stale PR: AbdullahBakir97/JS-TO-DO-LIST#1
  - This PR has been open for 1153 days. Review or close at https://github.com/AbdullahBakir97/JS-TO-DO-LIST/pull/1 to keep your contribution graph honest.
  - Awaiting: unknown (1153 days)
  - Evidence: [Opened 1153 days ago](https://github.com/AbdullahBakir97/JS-TO-DO-LIST/pull/1)
  - **Action:** Update with a fresh comment, mark as draft, or close.

- **[high]** `pr-rot` — Stale PR: bloghd/bloghd#1
  - This PR has been open for 103 days. Review or close at https://github.com/bloghd/bloghd/pull/1 to keep your contribution graph honest.
  - Awaiting: unknown (103 days)
  - Evidence: [Opened 103 days ago](https://github.com/bloghd/bloghd/pull/1)
  - **Action:** Update with a fresh comment, mark as draft, or close.

- **[medium]** `bug-debt` — Bug debt: AbdullahBakir97/Project-Management-Tool
  - 2 open issues; the oldest is 799 days old. Long-lived issues compound and signal abandonment to visitors.
  - Label weight: × 2 (dominant labels: bug)
  - Evidence: [2 open · oldest 799 days](https://github.com/AbdullahBakir97/Project-Management-Tool/issues)
